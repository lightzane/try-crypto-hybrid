...
export async function EXAMPLE_RECOMMENDED_2() {
  ...
  function toB64(arrayBuffer: ArrayBuffer | Uint8Array) {
    if (arrayBuffer instanceof ArrayBuffer) {
      arrayBuffer = new Uint8Array(arrayBuffer)
    }
    return window.btoa(String.fromCharCode(...arrayBuffer))
  }

  console.log("Alice's Original Message:", message)
  console.log("Alice's Ciphertext (Base64):", toB64(cipherText))
